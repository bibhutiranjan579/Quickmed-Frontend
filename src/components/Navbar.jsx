...
const Navbar = () => {
    ...
    return (
        <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-300'>
            ...
            {/* <h1 onClick={() => navigate('/')}>QuickMed</h1> */}
            ...
            <div className='flex items-center gap-4'>
                {
                    token && userData
                        ...
                        : <button
                            ...
                            className='bg-green-500 text-white px-8 py-3 rounded-full font-light hidden md:block hover:bg-green-600 transition duration-300 ease-in-out'
                        >
                            Create account
                        </button>
                }
