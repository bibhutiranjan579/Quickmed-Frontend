    ...
    <div>
      ...
      <div className='my-8 flex flex-col justify-center md:flex-row gap-10 mb-28 text-sm'>
        ...
        <div className='flex flex-col justify-center items-start gap-6'>
          ...
          <p className='text-gray-500'>MBH-B, NIT Jalandhar <br /> Grand Trunk Road, Barnala - Amritsar Bypass Rd, Jalandhar, Punjab 144011</p>
          <p className='text-gray-500'>Tel: (+91) 1811234567 <br /> Email: quickmed@gmail.com </p>
          <p className='font-semibold text-lg text-gray-600'>Careers at QuickMed</p>
