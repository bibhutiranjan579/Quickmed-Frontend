...
import cancelIcon from '../../assets/cancel_icon.svg'; // Direct import for cancel icon
import tickIcon from '../../assets/tick_icon.svg'; // Direct import for tick icon
    ...
    <div className='m-5'>
      <div className='flex flex-wrap gap-3'>
        ...
        <div className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all'>
          <img className='w-14' src={earningIcon} alt='Earnings Icon' />
          <div>
                ...
                </div>
                {
                  item.cancelled
                    ...
                    : item.isCompleted
                      ...
                      : <div className='flex'>
                          <img onClick={() => cancelAppointment(item._id)} className='w-10 cursor-pointer' src={cancelIcon} alt="Cancel Icon" />
                          <img onClick={() => completeAppointment(item._id)} className='w-10 cursor-pointer' src={tickIcon} alt="Complete Icon" />
                        </div>
                }
              </div>
            ))
